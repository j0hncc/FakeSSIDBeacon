...
void Bushel() {
  sendBeacon("How much do I love Susan");
  sendBeacon("A bushel and a peck");
  sendBeacon("A hug around the neck");
  sendBeacon("A barrel and a heap");
  sendBeacon("And Im talking in my sleep");
  sendBeacon("Toodle-doodle-doo-doo..");
  sendBeacon("Bet your pretty neck I do!!!");
}  

void Anniversary() {
  sendBeacon("Happy 50th Anniversary!");
  sendBeacon("Ken and Melanie!");
}
